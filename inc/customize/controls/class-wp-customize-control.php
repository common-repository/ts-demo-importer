...
class WP_Customize_Control {
	...
	protected function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'select':
				...
				<select id="<?php echo esc_attr( $input_id ); ?>" <?php echo esc_attr($describedby_attr); ?> <?php echo esc_url($this->link()); ?>>
					<?php
					foreach ( $this->choices as $value => $label ) {
						?>
						<option value="<?php echo esc_attr( $value ) ?>" <?php selected( $this->value(), $value, false ) ?>>
			...
			case 'dropdown-pages':
				...
				$show_option_none  = __( '&mdash; Select &mdash;','ts-demo-importer' );
				$option_none_value = '0';
				...
				<?php if ( $this->allow_addition && current_user_can( 'publish_pages' ) && current_user_can( 'edit_theme_options' ) ) : // Currently tied to menus functionality. ?>
					<button type="button" class="button-link add-new-toggle">
						...
						printf( __( '+ %s','ts-demo-importer' ), get_post_type_object( 'page' )->labels->add_new_item );
						?>
					</button>
					<div class="new-content-item">
						<label for="create-input-<?php echo esc_attr($this->id); ?>"><span class="screen-reader-text"><?php esc_html_e( 'New page title','ts-demo-importer' ); ?></span></label>
						<input type="text" id="create-input-<?php echo esc_attr($this->id); ?>" class="create-item-input" placeholder="<?php esc_attr_e( 'New page title&hellip;','ts-demo-importer' ); ?>">
						<button type="button" class="button add-content"><?php _e( 'Add','ts-demo-importer' ); ?></button>
					</div>
				<?php endif; ?>
				<?php
				break;
	...
	final public function print_template() {
		?>
		<script type="text/html" id="tmpl-customize-control-<?php echo esc_html($this->type); ?>-content">
