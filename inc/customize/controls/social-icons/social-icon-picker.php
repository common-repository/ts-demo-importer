...
class ts_demo_importer_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="tssocialInput" type="text" placeholder="<?php echo esc_attr_x( 'Search Icon', 'placeholder', 'ts-demo-importer'); ?>">
                </div>
                ...
                <ul class="total-icon-list clearfix">
                    <?php
                    $ts_demo_importer_font_awesome_icon_array = ts_demo_importer_font_awesome_icon_array();
                    foreach ($ts_demo_importer_font_awesome_icon_array as $ts_demo_importer_font_awesome_icon) {
                            $icon_class = $this->value() == $ts_demo_importer_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ts_demo_importer_font_awesome_icon).'"></i>
                            <span class="ts-social-class">'.esc_attr($ts_demo_importer_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
                <input type="hidden" value="<?php esc_attr($this->value()); ?>" <?php echo esc_url($this->link()); ?> />
            </label>
        <?php
    }
}
function ts_demo_importer_customizer_script() {

    wp_enqueue_style( 'font-awesome-1', TS_DEMO_IMPOTER_URL. 'inc/customize/controls/social-icons/css/font-awesome.css', array(), TS_DEMO_IMPOTER );
    wp_enqueue_style( 'total-customizer-style', TS_DEMO_IMPOTER_URL. 'inc/customize/controls/social-icons/css/customizer-style.css', array(), TS_DEMO_IMPOTER );
    wp_enqueue_script( 'si-customizer-script', TS_DEMO_IMPOTER_URL . 'inc/customize/controls/social-icons/js/customizer-scripts.js', array( 'jquery' ), TS_DEMO_IMPOTER, true );

}
add_action( 'customize_controls_enqueue_scripts', 'ts_demo_importer_customizer_script' );

if(!function_exists('ts_demo_importer_font_awesome_icon_array')){
    function ts_demo_importer_font_awesome_icon_array(){
