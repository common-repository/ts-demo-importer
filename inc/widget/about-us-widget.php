...
class ts_demo_importer_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'ts_demo_importer_About_Widget',
			__('About Us', 'ts-demo-importer'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'ts-demo-importer' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','ts-demo-importer'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','ts-demo-importer'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','ts-demo-importer'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','ts-demo-importer'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','ts-demo-importer'); ?></label>
...
function ts_demo_importer_about_custom_load_widget() {
	register_widget( 'ts_demo_importer_About_Widget' );
}
add_action( 'widgets_init', 'ts_demo_importer_about_custom_load_widget' );